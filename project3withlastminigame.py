...
#Mixing circle minigame
                positions = [Point(210,300), Point(240,300), Point(270,300)]
                bub1 = Circle(positions[0],15)
                bub2 = Circle(positions[1],15)
                bub3 = Circle(positions[2],15)
                bubbles = [bub1, bub2, bub3]
                bub1top = Circle(positions[0],15)
                bub2top = Circle(positions[1],15)
                bub3top = Circle(positions[2],15)
                bubbles = [bub1, bub2, bub3]
                bub1top.setFill("black")
                bub2top.setFill("black")
                bub3top.setFill("black")
                colors = ["black", "black", "yellow"]
                
                randcolor = random.randint(0,2)
                bub1.setFill(colors[randcolor])
                colors.remove(colors[randcolor])

                randcolor = random.randint(0,1)
                bub2.setFill(colors[randcolor])
                colors.remove(colors[randcolor])
                
                bub3.setFill(colors[0])
                ...
                bub1top.draw(GameWin)
                bub2top.draw(GameWin)
                bub3top.draw(GameWin)

                GameWin.getMouse()
                for i in range(5):
                    num = random.randint(0,2)
                    positions = [Point(210,300), Point(240,300), Point(270,300)]
                    moveTo(bub1,positions[num])
                    positions.remove(positions[num])
                    time.sleep(1)

                    num = random.randint(0,1)
                    moveTo(bub2,positions[num])
                    positions.remove(positions[num])
                    time.sleep(1)

                    num = 0
                    moveTo(bub3,positions[num])
